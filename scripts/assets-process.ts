...
function applyRayFallback(){var locale=document.documentElement.getAttribute("data-locale")==="zh"?"zh":"en";var fallback=locale==="zh"?"\\u5f85\\u751f\\u6210":"Pending";each("[data-ray-id]",function(node){var value=(node.textContent||"").replace(/^\\s+|\\s+$/g,"");if(isRayFallback(value)){node.textContent=fallback;}});}
