...
function isRayFallback(value){return !value||value.indexOf("::RAY_ID::")!==-1||value==="7F4C-9A21-RAY"||value==="\\u7531 Cloudflare \\u751f\\u6210"||value==="Generated by Cloudflare";}
function applyRayFallback(){var locale=document.documentElement.getAttribute("data-locale")==="zh"?"zh":"en";var fallback=locale==="zh"?"\\u7531 Cloudflare \\u751f\\u6210":"Generated by Cloudflare";each("[data-ray-id]",function(node){var value=(node.textContent||"").replace(/^\\s+|\\s+$/g,"");if(isRayFallback(value)){node.textContent=fallback;}});}
